...
const MESSAGES = {
  ...
  signup: "Signup successful. You can now log in.",
    ...
    <div className="bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200">
      ...
      <main className="container mx-auto px-6 pt-32 pb-16 text-center">
        ...
        <p className="text-lg md:text-xl text-zinc-600 dark:text-zinc-400 max-w-3xl mx-auto mb-8">
          Signal Sync provides AI-powered background verification on companies, helping retail
          investors make smarter, more informed decisions.
        </p>
        <Link
          href="/signup"
          className="bg-blue-600 text-white px-8 py-3 rounded-md text-lg font-semibold hover:bg-blue-500 transition-transform transform hover:scale-105"
        >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature) => (
              <div
                key={feature.name}
                className="bg-white dark:bg-zinc-700 p-6 rounded-lg shadow-md text-center"
              >
